#!/usr/bin/env bash
# =============================================================================
# vllm/start_secondary.sh — 廃止済み (DEPRECATED)
# =============================================================================
# 2026-04-14: Qwen 2.5 72B AWQ 単体構成への移行に伴い廃止。
# Primary (start_primary.sh) のみ使用してください。
# =============================================================================
echo "[DEPRECATED] start_secondary.sh は廃止されました。"
echo "  単体構成: bash vllm/start_primary.sh を使用してください。"
exit 1
